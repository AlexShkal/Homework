...
def event_and_match_interval_m10_10(value: int) -> bool:
    return value % 2 == 1 and -10 < value < 10
...
# https://goo.su/ipKzbY
print("min_raw ->", min_raw(-2, 4))# https://learn.microsoft.com/ru-ru/cpp/build/ieee-floating-point-representation?view=msvc-170
